# 168.Claude Code企业级应用实战

示例代码：claude-enterprise.zip (28 KB)
...
安装和配置 Claude Code 非常简单，详细步骤请参考官方文档：[https://docs.anthropic.com/zh-CN/docs/claude-code/setup](https://docs.anthropic.com/zh-CN/docs/claude-code/setup)
...
中文翻译：[https://github.com/li-zhixin/claude-ignore/blob/main/README_CN.md](https://github.com/li-zhixin/claude-ignore/blob/main/README_CN.md)
